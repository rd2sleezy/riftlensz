"""Research-only exact R-012 finding-window capture + V.2 analysis.

Set RIFTLENS_V2_T4=1 to request a real R.10 capture. Without the flag this
...
def main() -> int:
    parser = argparse.ArgumentParser(description="V.2 exact finding-window capture")
    ...
    enabled = os.environ.get("RIFTLENS_V2_T4") == "1"
